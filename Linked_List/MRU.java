...
//An implementation of Most recently used (MRU) using Singly Linked List

/*
* A cache is a high-speed storage that reduces the retrieval time of data. Thus , cache is applied for most frequently accessed data.
* MRU is an algorithm for most recently used data
* Least recently used (LRU) Cache oganises elements in order of use, allowing you to quickly identify which element hasn't been used for the longest amount of time.
*/
class Node{
